package com.ailikes.lotus.gateway.grpc.lib;
...
public final class BizGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<BizOuterClass.GprcRequest,
      BizOuterClass.GprcReply> getProcessMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Process",
      requestType = BizOuterClass.GprcRequest.class,
      responseType = BizOuterClass.GprcReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<BizOuterClass.GprcRequest,
      BizOuterClass.GprcReply> getProcessMethod() {
    io.grpc.MethodDescriptor<BizOuterClass.GprcRequest, BizOuterClass.GprcReply> getProcessMethod;
    if ((getProcessMethod = BizGrpc.getProcessMethod) == null) {
      synchronized (BizGrpc.class) {
        if ((getProcessMethod = BizGrpc.getProcessMethod) == null) {
          BizGrpc.getProcessMethod = getProcessMethod = 
              io.grpc.MethodDescriptor.<BizOuterClass.GprcRequest, BizOuterClass.GprcReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Biz", "Process"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  BizOuterClass.GprcRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  BizOuterClass.GprcReply.getDefaultInstance()))
  ...
  public static abstract class BizImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void process(BizOuterClass.GprcRequest request,
                        io.grpc.stub.StreamObserver<BizOuterClass.GprcReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                BizOuterClass.GprcRequest,
                BizOuterClass.GprcReply>(
  ...
  public static final class BizBlockingStub extends io.grpc.stub.AbstractStub<BizBlockingStub> {
    ...
    /**
     */
    public BizOuterClass.GprcReply process(BizOuterClass.GprcRequest request) {
  ...
  public static final class BizFutureStub extends io.grpc.stub.AbstractStub<BizFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<BizOuterClass.GprcReply> process(
        BizOuterClass.GprcRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PROCESS:
          serviceImpl.process((BizOuterClass.GprcRequest) request,
              (io.grpc.stub.StreamObserver<BizOuterClass.GprcReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class BizBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return BizOuterClass.getDescriptor();
    }
